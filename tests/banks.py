    ...
    result = [
        {
            ...
            "account_number": "4d2ec91f37bc553bc538e91195669b666e26b2ea3e4e31"
            "507e",
            "trust": "75.21",
        }
    ]
    ...
    blocks = [
        {
            ...
            "block_identifier": "824614aa97edb391784b17ce6956b70aed31edf741c1"
            "858d43ae4d566b2a13ed",
...
def test_success_fetch_banks(requests_mock):
    result = {
        ...
        "results": [
            {
                "account_number": "7977b7f7a6f52bf9ebda93694d9276e9e23049eb40"
                "b263799fb2a35fa9316b9b",
                "ip_address": "143.110.141.4",
                "node_identifier": "735bfc11f802dbb8365998703539823d751ac5f5f"
                "82905143fba8a84d967f29b",
                "port": None,
                "protocol": "http",
                "version": "v1.0",
...
def test_success_fetch_config(requests_mock):
    result = {
        "primary_validator": {
            "account_number": "1a105575c681c5c4bbd9e88a90346f356051646dcee254"
            "afd5fdc67782cc6e56",
            "ip_address": "20.188.33.93",
            "node_identifier": "4a02e9e03ca6f2e64fe8dc675da73e31b8112e4354391"
            "89012944f0b7adebf50",
            "port": None,
            "protocol": "http",
            "version": "v1.0",
            "default_transaction_fee": 1,
            "root_account_file": "http://20.188.33.93/media/root_account_file"
            ".json",
            "root_account_file_hash": "b2885f94cd099a8c5ba5355ff9cdd69252b4ca"
            "d2541e32d20152702397722cf5",
            "seed_block_identifier": "",
            "daily_confirmation_rate": 100,
            "trust": "100.00",
        },
        "account_number": "5878f25f576eb9d398ab1b6dd8b2e831ad74a58e6d6b8c8bea"
        "1c48f69a9db42d",
        "ip_address": "20.188.58.140",
        "node_identifier": "d1f994720d89c9d3b300367fdb85a452fd1fbb7d60c2e2707"
        "ff059e8df48e081",
        "port": None,
        "protocol": "http",
        "version": "v1.0",
...
def test_success_patch_trust_level(requests_mock):
    result = {
        "account_number": "5e12967707909e62b2bb2036c209085a784fabbc3deccefee7"
        "0052b6181c8ed8",
        "ip_address": "192.168.1.232",
        "node_identifier": "d5356888dc9303e44ce52b1e06c3165a7759b9df1e6a6dfbd"
        "33ee1c3df1ab4d1",
        "port": "80",
        "protocol": "http",
        "version": "v1.0",
    ...
    requests_mock.patch(
        "http://10.2.3.4:80/banks/d5356888dc9303e44ce52b1e06c3165a7759b9df1e6"
        "a6dfbd33ee1c3df1ab4d1",
        json=result,
    )
    ...
    response = bank.patch_trust_level(
        trust=99.98,
        signature="d11c5f7fcc5f541a94ceee7c73972b21c73912e41f06cc22989863fa22"
        "529"
        "f55d0b81bc9f95a203191be0259518bdfe073de77d87a7230d37bb14f21666ee40a",
        node_identifier="d5356888dc9303e44ce52b1e06c3165a7759b9df1e6a6dfbd33e"
        "e1c3df1ab4d1",
    )
...
def test_success_patch_validator(requests_mock):
    result = {
        "account_number": "ad1f8845c6a1abb6011a2a434a079a087c460657aad54329a8"
        "4b406dce8bf314",
        "ip_address": "192.168.1.75",
        "node_identifier": "3afdf37573f1a511def0bd85553404b7091a76bcd79cdcebb"
        "a1310527b167521",
        "port": None,
        "protocol": "http",
        "version": "v1.0",
        "default_transaction_fee": "4.0000000000000000",
        "root_account_file": "https://gist.githubusercontent.com/buckyroberts"
        "/519b5cb82a0a5b5d4ae8a2175b722520"
        "/raw/9237deb449e27cab93cb89ea3346ecdfc61fe9ea/0.json",
        "root_account_file_hash": "4694e1ee1dcfd8ee5f989e59ae40a9f751812bf5ca"
...
def test_success_post_invalid_block(requests_mock):
    result = {
        ...
        "created_date": "2020-07-11T18:44:16.518695Z",
        "modified_date": "2020-07-11T18:44:16.518719Z",
        "block_identifier": "65ae26192dfb9ec41f88c6d582b374a9b42ab58833e16124"
        "52d7a8f685dcd4d5",
        "block": "3ff4ebb0-2b3d-429b-ba90-08133fcdee4e",
        "confirmation_validator": "fcd2dce8-9e4f-4bf1-8dac-cdbaf64e5ce8",
        "primary_validator": "51461a75-dd8d-4133-81f4-543a3b054149",
    ...
    response = bank.post_invalid_block(
        block={
            "account_number": "0cdd4ba04456ca169baca3d66eace869520c62fe844213"
            "29086e03d91a68acdb",
            "message": {
                "balance_key": "ce51f0d9facaa7d3e69657429dd3f961ce70077a8efb5"
                "3dcda508c7c0a19d2e3",
                "txs": [
                    {
                        "amount": 12,
                        "recipient": "484b3176c63d5f37d808404af1a12c4b9649cd6"
                        "f6769f35bdf5a816133623fbc",
                    },
                    {
                        "amount": 1,
                        "recipient": "5e12967707909e62b2bb2036c209085a784fabb"
                        "c3deccefee70052b6181c8ed8",
                    },
                    {
                        "amount": 4,
                        "recipient": "ad1f8845c6a1abb6011a2a434a079a087c46065"
                        "7aad54329a84b406dce8bf314",
                    },
                ],
            },
            "signature": "ee5a2f2a2f5261c1b633e08dd61182fd0db5604c853ebd8498f"
            "6f28ce8e2ccbbc"
            "38093918610ea88a7ad47c7f3192ed955d9d1529e7e390013e43f25a5915c0f",
        },
        block_identifier="65ae26192dfb9ec41f88c6d582b374a9b42ab58833e1612452d"
        "7a8f685dcd4d5",
        primary_validator_node_identifier="3afdf37573f1a511def0bd85553404b709"
        "1a76bcd79cdcebba1310527b167521",
        node_identifier="59479a31c3b91d96bb7a0b3e07f18d4bf301f1bb0bde05f8d36d"
        "9611dcbe7cbf",
        signature="c61ef8067307f8a48979a656699709e415692eb7b7b0083e3cd41da4ff"
        "6cb388e7347896b5cacb0a74200390d"
