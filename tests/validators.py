    ...
    accounts = [
        {
            ...
            "account_number": "9bfa37627e2dba0ae48165b21"
            "9e76ceaba036b3db8e84108af73a1cce01fad35",
            "balance": 6,
            "balance_lock": "749f6faa4eeeda50f51334e903a"
            "1eaae084435d53d2a85fb0993a518fef27273",
        },
        {
            "id": "9c6dd61a-438c-4a95-b1d2-33f90bd7f6ad",
            "account_number": "2e86f48216567302527b69eae"
            "6c6a188097ed3a9741f43cc3723e570cf47644c",
            "balance": 380,
            "balance_lock": "aca94f4d2f472c6b9b662f60aab"
...
def test_success_fetch_account_balance(requests_mock):
    ...
    requests_mock.get(
        "http://42.0.6.9:80/accounts/a37e2836805975f3"
        "34108b55523634c995bd2a4db610062f404510617e83126f/balance",
        json=result,
    )
...
def test_success_fetch_account_balance_lock(requests_mock):
    result = {
        "balance_lock": "e9a91c4aed7593fd08bae4daac"
        "411e3a6bd1e01dc56cd2f5f060f8c790414f35"
    }

    requests_mock.get(
        "http://42.0.6.9:80/accounts/a37e2836805975f334108b555"
        "23634c995bd2a4db610062f404510617e83126f/balance_lock",
        json=result,
    )
...
def test_success_fetch_confirmation_blocks(requests_mock):
    result = {
        "message": {
            "block": {
                ...
                "message": {
                    "balance_key": "e6a41b658e17ab2db4355176c816"
                    "0de6a66b07e5cbdd85244b55b38b4fd26e92",
                    "txs": [
                        {
                            "amount": 60,
                ...
                "signature": "d857184b7d3121a8f9dccab09062fafc82dd0f"
                "b30a5d53e19ab25a587171bb9c6b33858353cd3ff7ddc1ad2bf"
    ...
    requests_mock.get(
        "http://42.0.6.9:80/confirmation_blocks/4c9595b2b661a23e66525"
        "6d6826ae940bd4ea82bef0c1ba7b3104e40a4c42b91/valid",
        json=result,
    )
...
def test_success_fetch_config(requests_mock):
    result = {
        ...
        "account_number": "2e86f48216567302527b69eae6c"
        "6a188097ed3a9741f43cc3723e570cf47644c",
        "ip_address": "54.183.17.224",
        "node_identifier": "2262026a562b0274163158e92e"
        "8fbc4d28e519bc5ba8c1cf403703292be84a51",
        "port": None,
        "protocol": "http",
        "version": "v1.0",
        "default_transaction_fee": 1,
        "root_account_file": "http://54.183.17.224/media/root_account_file.json",
        "root_account_file_hash": "cc9390cc579dc8a99a1f3"
        "4c1bea5d54a0f45b27ecee7e38662f0cd853f76744d",
...
def test_success_connection_request(requests_mock):
    ...
    requests_mock.post("http://42.0.6.9:80/connection_requests", json=result)

    validator = Validator(address="42.0.6.9")
    response = validator.connection_requests(
        node_id="d5356888dc9303e44ce52b1e06c3165a7759b9df1e6a6dfbd33ee1c3df1ab4d1",
        signature="3c88665e123e7e25a8b9d9592f3269ab4efc4bcba989a103a898e262593"
        "3261b1cccdaf2f52eca9c58d2bf033968ab6b702089bca8fc6e0c80b3b002a5e05b03",
    )
...
def test_success_fetch_bank(requests_mock):
    result = {
        "account_number": "dfddf07ec15cbf363ecb52eedd"
        "7133b70b3ec896b488460bcecaba63e8e36be5",
        "ip_address": "143.110.137.54",
        "node_identifier": "6dbaff44058e630cb375955c8"
        "2b0d3bd7bc7e20cad93e74909a8951f747fb8a4",
        "port": None,
        "protocol": "http",
        "version": "v1.0",
        "default_transaction_fee": 1,
    ...
    node_id = "6dbaff44058e630cb375955c82b0d3"
    "bd7bc7e20cad93e74909a8951f747fb8a4"
...
def test_success_patch_bank(requests_mock):
    result = {
        ...
        "7133b70b3ec896b488460bcecaba63e8e36be5",
        "ip_address": "143.110.137.54",
        "node_identifier": "d5356888dc9303e44ce52b1e0"
        "6c3165a7759b9df1e6a6dfbd33ee1c3df1ab4d1",
        "port": None,
        "protocol": "http",
        "version": "v1.0",
        "default_transaction_fee": 1,
    ...
    node_id = "d5356888dc9303e44ce52b1e06c316"
    "5a7759b9df1e6a6dfbd33ee1c3df1ab4d1"
    signature = (
        "3c88665e123e7e25a8b9d9592f3269ab4efc4bcba989a103a898e2625933261b1ccc"
        "daf2f52eca9c58d2bf033968ab6b702089bca8fc6e0c80b3b002a5e05b03"
    )
...
def test_success_fetch_validators(requests_mock):
    validators = [
        {
            "account_number": "4699a423c455a40feb1d6b90"
            "b167584a880659e1bf9adf9954a727d534ff0c16",
            "ip_address": "54.219.178.46",
            "node_identifier": "b1b232503b3db3975524faf"
            "98674f22c83f4357c3d946431b8a8568715d7e1d9",
            "port": None,
            "protocol": "http",
            "version": "v1.0",
            "default_transaction_fee": 1,
            "root_account_file": "https://gist.githubusercontent.com/bucky"
            "roberts/0688f136b6c1332be472a8baf10f78c5/raw/323fcd29672e392be"
            "2b934b82ab9eac8d15e840f/alpha-00.json",
            "root_account_file_hash": "0f775023bee79884fbd9a90a76c5eacfee3"
            "8a8ca52735f7ab59dab63a75cbee1",
            "seed_block_identifier": "",
            "daily_confirmation_rate": None,
            "trust": "0.00",
        },
        {
            "account_number": "d5c4db217c032ef21df84be4201766b"
            "73e623940ce6d95aedf153da2f8c38626",
            "ip_address": "54.67.72.197",
            "node_identifier": "61dbf00c2dd7886f01fda60aca6fffd"
            "9799f4612110fe804220570add6b28923",
            "port": None,
            "protocol": "http",
            "version": "v1.0",
            "default_transaction_fee": 1,
            "root_account_file": "https://gist.githubusercontent.com/"
            "buckyroberts/0688f136b6c1332be472a8baf1"
            "0f78c5/raw/323fcd29672e392be2b934b82ab9eac8d15e840f/alpha-00.json",
            "root_account_file_hash": "0f775023bee79884fbd9a90a7"
            "6c5eacfee38a8ca52735f7ab59dab63a75cbee1",
            "seed_block_identifier": "",
            "daily_confirmation_rate": None,
            "trust": "0.00",
        },
...
def test_success_fetch_validators_page_2(requests_mock):
    validators = [
        {
            "account_number": "4699a423c455a40feb1d6b90b167"
            "584a880659e1bf9adf9954a727d534ff0c16",
            "ip_address": "54.219.178.46",
            "node_identifier": "b1b232503b3db3975524faf9867"
            "4f22c83f4357c3d946431b8a8568715d7e1d9",
            "port": None,
            "protocol": "http",
            "version": "v1.0",
            "default_transaction_fee": 1,
            "root_account_file": "https://gist.githubusercontent.com/"
            "buckyroberts/0688f136b6c1332be472"
            "a8baf10f78c5/raw/323fcd29672e392be2b934b82ab9eac8d15e840f/"
            "alpha-00.json",
            "root_account_file_hash": "0f775023bee79884fbd9a"
            "90a76c5eacfee38a8ca52735f7ab59dab63a75cbee1",
            "seed_block_identifier": "",
            "daily_confirmation_rate": None,
            "trust": "0.00",
        },
        {
            "account_number": "d5c4db217c032ef21df84be42"
            "01766b73e623940ce6d95aedf153da2f8c38626",
            "ip_address": "54.67.72.197",
            "node_identifier": "61dbf00c2dd7886f01fda60a"
            "ca6fffd9799f4612110fe804220570add6b28923",
            "port": None,
            "protocol": "http",
            "version": "v1.0",
            "default_transaction_fee": 1,
            "root_account_file": "https://gist.githubusercontent.com/"
            "buckyroberts/0688f136b6c1332be472a"
            "8baf10f78c5/raw/323fcd29672e392be2b934b82ab9eac8d15e840f/"
            "alpha-00.json",
            "root_account_file_hash": "0f775023bee79884fb"
            "d9a90a76c5eacfee38a8ca52735f7ab59dab63a75cbee1",
            "seed_block_identifier": "",
            "daily_confirmation_rate": None,
            "trust": "0.00",
        },
...
def test_success_fetch_validator(requests_mock):
    result = {
        "account_number": "2e86f48216567302527b69eae6c6a"
        "188097ed3a9741f43cc3723e570cf47644c",
        "ip_address": "54.183.17.224",
        "node_identifier": "2262026a562b0274163158e92e8"
        "fbc4d28e519bc5ba8c1cf403703292be84a51",
        "port": None,
        "protocol": "http",
        "version": "v1.0",
        "default_transaction_fee": 1,
        "root_account_file": "http://54.183.17.224/media/root_account_file.json",
        "root_account_file_hash": "cc9390cc579dc8a99a1f"
        "34c1bea5d54a0f45b27ecee7e38662f0cd853f76744d",
        "seed_block_identifier": "",
        "daily_confirmation_rate": None,
        "trust": "100.00",
    }
...
def test_success_patch_validator(requests_mock):
    ...
    node_id = "d5356888dc9303e44ce52b1e06c3165a7759b9df1e6a6dfbd33ee1c3df1ab4d1"
    signature = (
        "3c88665e123e7e25a8b9d9592f3269ab4efc4bcba989a103a898e2625933261b1cc"
        "cdaf2f52eca9c58d2bf033968ab6b702089bca8fc6e0c80b3b002a5e05b03"
    )
    requests_mock.patch(f"http://42.0.6.9:80/validators/{node_id}", json=result)

    validator = Validator(address="42.0.6.9")
    response = validator.patch_validators(
