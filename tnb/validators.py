...
class Validator(BaseClient):
    ...
    def fetch_account_balance(self, account_number: str) -> object:
        """
    ...
    def fetch_account_balance_lock(self, account_number: str) -> object:
        """
    ...
    def fetch_confirmation_block(self, block_identifier: str) -> object:
        """
